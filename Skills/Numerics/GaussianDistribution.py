...
class GaussianDistribution():
    ...
    def __mul__(self, other):
        return GaussianDistribution.from_precision_mean(
    ...
    def cumulative_to(x, mean=0.0, stdev=1.0):
        result = GaussianDistribution.error_function_cumulative_to(INV_SQRT_2 * x)
        return 0.5 * result
    ...
    def inverse_error_function_cumulative_to(p):
        ...
        for _ in range(2):
            err = GaussianDistribution.error_function_cumulative_to(x) - pp
    ...
    def inverse_cumulative_to(x, mean=0.0, stdev=1.0):
        return mean - sqrt(2.0) * stdev * GaussianDistribution.inverse_error_function_cumulative_to(2.0 * x)
