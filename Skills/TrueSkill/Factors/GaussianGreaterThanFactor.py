...
class GaussianGreaterThanFactor(GaussianFactor):
    ...
    def log_normalization(self):
        ...
        return (-GaussianDistribution.log_product_normalization(message_from_variable, message) +
                log(GaussianDistribution.cumulative_to((message_from_variable.mean - self.epsilon)
