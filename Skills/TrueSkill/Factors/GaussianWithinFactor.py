...
class GaussianWithinFactor(GaussianFactor):
    ...
    def log_normalization(self):
        ...
        z = (GaussianDistribution.cumulative_to((self.epsilon - mean) / std) -
             GaussianDistribution.cumulative_to((-self.epsilon - mean) / std))

        return -GaussianDistribution.log_product_normalization(message_from_variable, message) + log(z)
