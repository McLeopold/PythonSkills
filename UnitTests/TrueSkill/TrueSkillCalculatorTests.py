...
class TwoPlayerCalculatorTests(CalculatorTests):
    ...
    def test_two_player_not_drawn(self):
        ...
        self.assertMatchQuality(0.447214, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_two_player_drawn(self):
        ...
        self.assertMatchQuality(0.447, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_one_on_one_massive_upset_drawn(self):
        ...
        self.assertMatchQuality(0.110, self.calculator.calculate_match_quality(game_info, teams))
...
class TwoTeamCalculatorTests(object):
    ...
    def test_two_on_two_unbalanced_draw(self):
        ...
        self.assertMatchQuality(0.214, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_two_on_two_upset(self):
        ...
        self.assertMatchQuality(0.084, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_one_on_two(self):
        ...
        self.assertMatchQuality(0.135, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_one_on_two_somewhat_balanced(self):
        ...
        self.assertMatchQuality(0.478, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_one_on_three(self):
        ...
        self.assertMatchQuality(0.012, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_one_on_seven(self):
        ...
        self.assertMatchQuality(0.000, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_three_on_two(self):
        ...
        self.assertMatchQuality(0.254, self.calculator.calculate_match_quality(game_info, teams))
...
class MultipleTeamCalculatorTests(CalculatorTests):
    ...
    def test_two_on_four_on_two_win_draw(self):
        ...
        self.assertMatchQuality(0.367, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_three_teams_of_one_not_drawn(self):
        ...
        self.assertMatchQuality(0.200, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_four_teams_of_one_not_drawn(self):
        ...
        self.assertMatchQuality(0.089, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_five_teams_of_one_not_drawn(self):
        ...
        self.assertMatchQuality(0.040, self.calculator.calculate_match_quality(game_info, teams))
    ...
    def test_eight_teams_of_one_drawn(self):
        ...
        self.assertMatchQuality(0.004, self.calculator.calculate_match_quality(game_info, teams))
...
class PartialPlayCalculatorTests(CalculatorTests):
    ...
    def test_one_on_two_balanced_partial_play(self):
        ...
        self.assertMatchQuality(0.4472135955, self.calculator.calculate_match_quality(game_info, teams))
